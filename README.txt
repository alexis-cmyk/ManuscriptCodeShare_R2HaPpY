...
This repository contains all analysis scripts, figure-generation code, and supporting materials used to reproduce the results of the manuscript:
...
- Example processed data tables required for reproducing plots  
- Utility scripts for QC, normalization, and phosphosite-level integration
...
This site allows exploration of phosphorylation patterns, gene-level quantification, replicate variability, and downstream functional annotation analyses.

---

## Protocols

The full experimental workflow, including SH2 Superbinder expression, bead preparation, enrichment, digestion, LC-MS/MS acquisition, and downstream processing, is documented on protocols.io:
...
Processed and intermediate data tables used in the figure-generation scripts (e.g., scaled intensities, summarized peptide tables, cluster assignments) are included directly in this repository under the `data/` subdirectory.
...
- `R/00_master_run_all_figures.R` (or your master script name)
- Individual figure-specific scripts in `R/figures/`
