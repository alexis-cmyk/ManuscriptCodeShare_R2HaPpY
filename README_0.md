...
1. Download the zip file containing folders raw_data/, output/, and modified_data/ from `Releases` and place in this R project directory.
2. Use R version 4.4.2
3. Run source("00_setup_environment.R")
4. Restart R
5. Run renv::restore()
6. Run source("00_master_run_all_figures.R")
...
This project was developed on windows using R version 4.4.2. 

- We highly recommend using version R 4.4.2 in this project for compatibility.
...
This project uses renv to provide a fully reproducible R environment, including exact package versions for **R 4.4.2** and **Bioconductor 3.22**.
