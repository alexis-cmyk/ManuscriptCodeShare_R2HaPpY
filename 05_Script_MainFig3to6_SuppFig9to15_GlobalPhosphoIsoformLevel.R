...
write_csv(x = global_isoform_shiny, file = "modified_data/MainFig3to6_SuppFig9to15/GlobalPhosphoIsoformLevel/GLOBAL_ISOFORM_input.csv")


## --------------------------------------------------------------------------------------------------------------------------------------------------
# write_csv(x = ascore_final_gene, file = "modified_data/MainFig3to6_SuppFig9to15/GlobalPhosphoIsoformLevel/GPisoform_SHINY_input.csv")
