---
title: "NHS_vs_Halo_20241223_1mg triplicate"
author: "Alexis Chang"
date: "`r Sys.Date()`"
...
# fxns_fasta <- read_tsv(file = "raw_data/fxns_UP000005640_2024_11_05.tsv") %>% clean_names() %>% 
...
comet <- read_csv("raw_data/SuppFig2/AC063_1_pept_input_range_20241224_comet/result.csv") %>% #ascore and comet files were switched & didn't bother to rename file.
  clean_names() %>% 
...
```
sample info for PRIDE
```{r}
sample_info_for_PRIDE <- comet %>% 
  distinct(raw_file_name, R2P2_well, condition, replicate,set_id)

write_csv(sample_info_for_PRIDE, file = "modified_data/SuppFig2/HiResAscore_20241224_PeptInputRange/sample_info_for_PRIDE.csv")
```


##_b. ASCORE
```{r}
ascore <- read_csv("raw_data/SuppFig2/AC063_1_pept_input_range_20241224_ascore/result.csv") %>% #ascore and comet files were switched & didn't bother to rename file.
