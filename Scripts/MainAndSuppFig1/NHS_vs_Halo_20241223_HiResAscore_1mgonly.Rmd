...
comet <- read_csv("raw_data/MainAndSuppFig1/AC063_NHS_vs_Halo_HiResAscore_ascore/result.csv") %>% #ascore and comet files were switched & didn't bother to rename file.
  clean_names() %>% 
...
##_b. ASCORE
```{r}
ascore <- read_csv("raw_data/MainAndSuppFig1/AC063_NHS_vs_Halo_HiResAscore_comet/result.csv") %>% #ascore and comet files were switched & didn't bother to rename file.
